...
if($try == 11 )
{
 ...
 $c=mysqli_query($con,"UPDATE FD SET fdissueddate='$fdissueddate', fdholder='$fdholdername', fdofbank='$fdholderbank', principleamt=$principleamt, nodays=$nodays, intrate=$intrate, intamt=$intamt, finalamt=$finalamt, maturitydate='$matdate', 
  fdentrydate='$fdentrydatez' where id=$fid") or die("Error: " . mysqli_error($con));

 //echo "UPDATE FD SET fdissueddate=$fdissueddate, fdholder='$fdholdername', fdofbank='$fdholderbank', principleamt=$principleamt, nodays=$nodays, intrate=$intrate, intamt=$intamt, finalamt=$finalamt, maturitydate=$matdate, fdentrydate=$fdentrydatez";
