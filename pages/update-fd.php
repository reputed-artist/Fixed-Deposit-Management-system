        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Update Fixed Deposit</h3>
            </div>
          </br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   ...
                   <option value=""></option>
                    ...
                    {
                      if($rs["c_name"] == $row['fdholder'])
                      {
                    ?>
                    <option value="<?php echo $rs["c_name"]; ?>" selected="selected"><?php echo $rs["c_name"]; ?></option>
                    <?php }

                      else { 
                     ?>
                     <option value="<?php echo $rs["c_name"]; ?>" ><?php echo $rs["c_name"]; ?></option>
                     <?php }} ?>
                    </select>
